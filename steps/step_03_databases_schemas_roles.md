...
This step creates the NorthBridge Bank lab environment and generates synthetic UK retail banking data. You will run two scripts:
...
- **Role** — determines what objects you can access and what operations you can perform
